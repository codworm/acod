...
exports.run = (client, message) => {
  ...
  let gifembed = new Discord.RichEmbed()
    ...
    .setTitle(`Mustafa Kemal Atatürk Photo`)
    .setColor("#5556ad")
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["mka-photo","mka-pp","mkapp","mustafa-kemal-atatürk-photo","mustafakemalatatürkphoto","mustafa-kemal-atatürk-pp","mustafakemalatatürkpp"],
  permLevel: 0
};
